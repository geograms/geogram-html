...
async function activityStartLocalMaps() {
  ...
  sideContainer.innerHTML = `
    ...
    <div id="tab-chat" class="nearby-tab-panel" style="display:block;width:100%;height:calc(100% - 60px);">
      <div id="chat-area" class="chat-area"
          style="width: 100%; height: 100%; display: flex; flex-direction: column; background: #000; border-radius: 4px; padding: 2px 8px 13px 8px; box-sizing: border-box;">
        <div style="margin-bottom: 0.5em; display:flex; align-items:center; gap: 0.5rem; flex-wrap: wrap; flex-shrink: 0;">
          <button id="locateBtn" title="Use my location" style="padding: 6px 10px; min-width: 40px;">
            <i class="fa-solid fa-location-crosshairs"></i>
          </button>
          <label style="display:flex; align-items:center; gap:.3rem; flex: 1; min-width: 200px;">
            <i class="fa-solid fa-ruler"></i>
            <input type="range" id="radiusInput" value="100" min="1" max="500" style="flex: 1; min-width: 80px; vertical-align: middle;" />
            <span id="radiusValue" style="min-width: 2.5em; text-align: right;">100</span> <span style="white-space: nowrap;">km</span>
          </label>
        </div>

        <div class="chat-messages" id="chatMessages"
             style="flex:1; overflow-y:auto; min-height:10; padding-right:4px;"></div>

        <div class="chat-input"
             style="margin-top:calc(0.5em); min-height:48px; display:flex; align-items:center; position:relative; background:inherit; gap: 4px; flex-shrink: 0;">
          ...
          <input id="chatInput" type="text" placeholder="Type a message..."
                 style="flex:1;padding:8px;border:1px solid var(--border);border-radius:4px;background:var(--card);color:var(--text,#fff);font-size:16px;" />
          <button id="sendChatBtn" class="action-button" title="Send" style="padding: 6px 8px; min-width: 36px;">
  ...
  // 5) Global emoji insert function
